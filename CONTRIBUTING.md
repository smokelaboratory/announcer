...
* Search [GitHub](https://github.com/smokelaboratory/announcer/pulls) for an open or closed Pull Request
  that relates to your submission. You don't want to duplicate effort.
* Please have a look at [License](https://github.com/smokelaboratory/announcer/blob/master/LICENSE) before sending pull
